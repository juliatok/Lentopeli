...
"""
def edellinen_nykyinen_lentokentta(maat_lista):

    edellinen = maat_lista[-2]
    nykyinen = maat_lista[-1]
    koordinaatit_1 = hae_koordinaatit(edellinen)
    koordinaatit_2 = hae_koordinaatit(nykyinen)

    return koordinaatit_1, koordinaatit_2
...
edellinen_nykyinen_lentokentta(käydytmaat)
